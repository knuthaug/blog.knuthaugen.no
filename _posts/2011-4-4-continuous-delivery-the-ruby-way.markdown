...
<pre class="brush: ruby">namespace :jenkins do
...
<a href="http://blog.knuthaugen.no/assets_c/2011/04/jenkinspipe-20.html" onclick="window.open('http://blog.knuthaugen.no/assets_c/2011/04/jenkinspipe-20.html','popup','width=1152,height=438,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0'); return false"><img src="http://blog.knuthaugen.no/assets_c/2011/04/jenkinspipe-thumb-600x228-20.png" width="600" height="228" alt="jenkinspipe.png" class="mt-image-none" style="" /></a>
